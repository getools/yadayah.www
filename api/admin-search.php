<?php
/**
 * Admin endpoint for search-wide settings (yy_setting scope='page', group='search').
 * Currently exposes the snippet length cap used when slicing
 * paragraph_text_plain around the matched term.
 *
 *   GET — { code: value, ... }
 *   PUT — { code: value, ... }   UPSERTs each
 *
 * Mirrors api/admin-flipbook.php exactly.
 */
