-- Fix DELETE triggers to increment revision_num before copying to _rev
DO $$
DECLARE
  t RECORD;
  pk_col text;
...
BEGIN
  ...
  LOOP
    ...
    $fn$,
      t.table_name,
      rev_num_col, rev_num_col,         -- DELETE: increment revision_num
      rev_dtime_col,                     -- DELETE: set revision_dtime
      rev_table, rev_del_col, col_list,  -- DELETE: insert into rev
      ...
      rev_table, rev_del_col, col_list   -- INSERT/UPDATE: insert into rev
    );
