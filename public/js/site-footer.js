...
(function() {
    ...
    lsStyle.textContent = ''
        ...
        + '@media (max-width:768px) { #livestream-popover { padding-top:0 !important;align-items:flex-start !important; } #livestream-popover-inner { flex-direction:column;width:100vw;height:100dvh;height:calc(100vh - 60px);margin-top:0 !important;border-radius:0; } #livestream-popover-inner .ls-player { flex:none;height:28%;min-height:130px; } #livestream-popover-inner .ls-chat { width:100%;flex:1;border-left:none;border-top:none;overflow:hidden; } }'
