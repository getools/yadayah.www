...
if ($citeIds === '') {
    $stmt = $pdo->query("SELECT DISTINCT translation_cite_chapter FROM yy_cite_translation WHERE translation_cite_chapter IS NOT NULL ORDER BY translation_cite_chapter");
} else {
